...
| [PE image profile contract](developer/pe_image_profile_contract.md) | Frozen contract; not implemented | Canonical in-memory PE profile: image identity, actual-versus-preferred base addressing, the sixteen directory descriptors, component coverage states, cache identity, and projection ownership |
