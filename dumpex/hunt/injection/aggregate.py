...
def build_report(rwx: tuple, hidden_pe_scan, validated_pe_hits: tuple, mz_only_hits: tuple,
    ...
    coverage = CoverageSnapshot(
        ...
        pe_short_reads_targets=hidden_pe_scan.short_read_targets,
        pe_scan_truncated=hidden_pe_scan.scan_truncated,
        pe_scan_truncated_groups=hidden_pe_scan.scan_truncated_groups,
        pe_scan_not_started=hidden_pe_scan.scan_not_started,
