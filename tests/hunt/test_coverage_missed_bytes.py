...
_NO_MEMORY_CLAIM = frozenset({
    ...
    "EXTRACT_MODULE_CONTEXT_UNAVAILABLE", "EXTRACT_MEMORY_INFO_UNAVAILABLE",
    "EXTRACT_PE_HEADER_VALIDATION_INCOMPLETE",
    ...
    "THREAD_INFO_STREAM_TRUNCATED", "THREAD_START_ADDRESS_UNAVAILABLE",
    ...
    "REGION_READ_TRUNCATED", "REPORT_MODULE_CONTEXT_UNAVAILABLE",
    "REPORT_PE_HEADER_VALIDATION_INCOMPLETE", "SOURCE_ABSENT",
