...
_DEFAULT_RULES = {
    ...
    "framework_pipes": [
        ...
        {"pattern": r"DserNamePipe",      "framework": "Various",
         "technique": "PrintNightmare / Spooler exploit pipe name",  "mitre": "T1068"},
