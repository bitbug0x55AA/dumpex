...
RECON_V213_SCENARIOS = [
    (
        ...
        '\n═══ PROCESS ═══\n  [~] no usable process identity evidence available (MiscInfo and the PEB supplied no usable PID, start time, path, command line, or image base)\n\n  Process Name           (unknown)\n  PID                    (unknown)\n  Path                   (unknown)\n  Command Line           (unknown)\n  Start Time (UTC)       (unknown)\n  Image Base             (unknown)\n\n  Main Image PE\n    (unavailable -- no image base to profile; see coverage above)\n\n  Import Address Table\n    (unavailable -- see coverage below)\n',
        {'kind': 'process', 'execution_status': 'completed', 'coverage': {'status': 'not_evaluated', 'reasons': ['no usable process identity evidence available (MiscInfo and the PEB supplied no usable PID, start time, path, command line, or image base)'], 'sources': {'process_identity': {'state': 'absent', 'record_count': None, 'detail': None}, 'misc_info': {'state': 'absent', 'record_count': None, 'detail': None}, 'peb': {'state': 'absent', 'record_count': None, 'detail': None}, 'modules': {'state': 'absent', 'record_count': None, 'detail': None}, 'main_image': {'state': 'absent', 'record_count': None, 'detail': None}, 'iat': {'state': 'absent', 'record_count': None, 'detail': None}}, 'limitations': [{'code': 'PROCESS_SOURCES_ABSENT', 'source': 'process_identity', 'scope': 'dump', 'affected_count': None, 'unavailable_fields': [], 'available_fields': [], 'counterpart_source': None, 'related_sources': [], 'related_tids': [], 'thread_id': None, 'detail': None, 'targets': [], 'budget_limit': None, 'budget_consumed': None}]}, 'summary': {'count': 1}, 'data': {'records': [{'process_name': None, 'pid': None, 'process_path': None, 'command_line': None, 'process_start_utc': None, 'image_base_address': None, 'iat': {'table_present': None, 'table_va': None, 'table_size': None, 'import_directory_present': None, 'import_directory_va': None, 'import_directory_size': None, 'has_entries': False, 'dll_count': 0, 'entry_count': 0, 'entries': [], 'diagnostics': []}, 'identity_evidence': {'misc_info_claim': {'pid': None, 'process_create_time_utc': None, 'raw_pid': None, 'raw_process_create_time': None}, 'peb_claim': {'image_base_address': None, 'image_path': None, 'name': None, 'raw_image_base_address': None, 'raw_image_path': None, 'raw_command_line': None}, 'module_claim': {'match_state': 'unavailable', 'base_address': None, 'name': None, 'path': None, 'name_matched_candidate': None, 'name_matched_candidate_ambiguous': False}, 'main_image_pe': {'checked': False, 'valid': None, 'reason': None}, 'selected_path_source': None, 'diagnostics': []}, 'pe_image': {'collected': False, 'correlated': False, 'unavailable_reason': 'no_image_base', 'source_kind': None, 'module_identity': {'value': None, 'form': None, 'truncated': False}, 'actual_base': None, 'preferred_image_base': None, 'format': None, 'machine': None, 'machine_name': None, 'time_date_stamp': None, 'checksum': None, 'subsystem': None, 'dll_characteristics': None, 'coff_characteristics': None, 'size_of_image': None, 'size_of_headers': None, 'section_alignment': None, 'file_alignment': None, 'declared_section_count': None, 'decoded_section_count': 0, 'structural_state': None, 'relocation': {'delta': None, 'relocs_stripped': None, 'dynamic_base': None, 'basereloc_present': None, 'basereloc_descriptor_state': None}, 'entry_point': {'rva': None, 'va': None, 'va_overflow': False, 'section_index': None, 'section_name': None, 'capture_state': None, 'region_state': None, 'region_type': None, 'region_protection': None}, 'acquisition': None, 'directory_summary': {'declared_count': None, 'declared_count_raw': None, 'readable_count': None, 'unprojected_count': None}, 'module_match': None, 'observation_coverage': {'total': 0, 'consistent': 0, 'conflict': 0, 'unavailable': 0, 'not_applicable': 0}, 'sections': [], 'directories': [], 'observations': []}}]}},
    ),
    (
        'process_complete', ['--process'], _process_complete, 0,
        '\n═══ PROCESS ═══\n\n  Process Name           malware.exe\n  PID                    4242 (0x1092)\n  Path                   C:\\Samples\\malware.exe\n  Command Line           "C:\\Samples\\malware.exe" -k\n  Start Time (UTC)       2026-08-14 01:15:05 UTC\n  Image Base             0x00007ff600010000\n\n  Main Image PE\n    Architecture     AMD64 / PE32+\n    Actual Base      0x00007ff600010000\n    Preferred Base   0x00007ff600010000\n    Relocation       not required -- loaded at the preferred base\n    Image Size       0x6000 (24576 bytes), 1 section(s)\n    Entry Point      RVA 0x1000 -> 0x00007ff600011000 (.text; capture none)\n    Loader Record    a module is registered at this image base\n    Structure        complete -- every header structure was read in full\n    Consistency      11 consistent, 0 conflicting, 3 unavailable, 15 not applicable\n    Scope            structural main-image checks only; this does not establish\n                     that the process is benign\n    [??] image size vs. mapped memory: unavailable -- no usable memory region table, so the mapping this image occupies could not be established\n    [??] the dump\'s memory region table is not in this dump\n    (use --verbose for the section table, the directory descriptors, the relocation evidence, and every consistency check)\n\n  Import Address Table\n    1 import(s) across 1 DLL(s)\n',
        {'kind': 'process', 'execution_status': 'completed', 'coverage': {'status': 'complete', 'reasons': [], 'sources': {'process_identity': {'state': 'present', 'record_count': 5, 'detail': None}, 'misc_info': {'state': 'present', 'record_count': 1, 'detail': None}, 'peb': {'state': 'present', 'record_count': 1, 'detail': None}, 'modules': {'state': 'present', 'record_count': 1, 'detail': None}, 'main_image': {'state': 'present', 'record_count': 1, 'detail': None}, 'iat': {'state': 'present', 'record_count': 1, 'detail': None}}, 'limitations': []}, 'summary': {'count': 1}, 'data': {'records': [{'process_name': 'malware.exe', 'pid': 4242, 'process_path': 'C:\\Samples\\malware.exe', 'command_line': '"C:\\Samples\\malware.exe" -k', 'process_start_utc': '2026-08-14 01:15:05 UTC', 'image_base_address': '0x00007ff600010000', 'iat': {'table_present': True, 'table_va': '0x00007ff600013000', 'table_size': 16, 'import_directory_present': True, 'import_directory_va': '0x00007ff600012000', 'import_directory_size': 40, 'has_entries': True, 'dll_count': 1, 'entry_count': 1, 'entries': [{'dll': 'KERNEL32.dll', 'import_by': 'name', 'symbol': 'CreateFileW', 'ordinal': None, 'iat_slot_va': '0x00007ff600013000', 'resolved_target_va': '0x00007ffb12345678', 'slot_in_bounds': True}], 'diagnostics': []}, 'identity_evidence': {'misc_info_claim': {'pid': 4242, 'process_create_time_utc': '2026-08-14 01:15:05 UTC', 'raw_pid': None, 'raw_process_create_time': None}, 'peb_claim': {'image_base_address': '0x00007ff600010000', 'image_path': 'C:\\Samples\\malware.exe', 'name': 'malware.exe', 'raw_image_base_address': None, 'raw_image_path': None, 'raw_command_line': None}, 'module_claim': {'match_state': 'resolved', 'base_address': '0x00007ff600010000', 'name': 'malware.exe', 'path': 'C:\\Samples\\malware.exe', 'name_matched_candidate': None, 'name_matched_candidate_ambiguous': False}, 'main_image_pe': {'checked': True, 'valid': True, 'reason': None}, 'selected_path_source': 'peb', 'diagnostics': []}, 'pe_image': {'collected': True, 'correlated': True, 'unavailable_reason': None, 'source_kind': 'peb_image_base', 'module_identity': {'value': 'C:\\Samples\\malware.exe', 'form': 'path', 'truncated': False}, 'actual_base': '0x00007ff600010000', 'preferred_image_base': '0x00007ff600010000', 'format': 'PE32+', 'machine': 34404, 'machine_name': 'AMD64', 'time_date_stamp': 305419896, 'checksum': 0, 'subsystem': 0, 'dll_characteristics': 0, 'coff_characteristics': 258, 'size_of_image': 24576, 'size_of_headers': 0, 'section_alignment': 0, 'file_alignment': 0, 'declared_section_count': 1, 'decoded_section_count': 1, 'structural_state': 'complete', 'relocation': {'delta': 0, 'relocs_stripped': False, 'dynamic_base': False, 'basereloc_present': False, 'basereloc_descriptor_state': 'declared_absent'}, 'entry_point': {'rva': 4096, 'va': '0x00007ff600011000', 'va_overflow': False, 'section_index': 0, 'section_name': '.text', 'capture_state': 'none', 'region_state': None, 'region_type': None, 'region_protection': None}, 'acquisition': {'requested_stage': 'sections', 'highest_completed_stage': 'sections', 'requested_bytes': 4096, 'captured_bytes': 944, 'read_bytes': 432, 'read_target_bytes': 432, 'target_io_short': False, 'bounded_stop': None, 'components': {'dos_header': 'complete', 'coff_header': 'complete', 'optional_header': 'complete', 'directory_array': 'complete', 'directory_descriptors': 'complete', 'section_table': 'complete'}, 'segment_table': 'enumerated', 'region_table': 'absent', 'capture_overlapping': False, 'unexamined': []}, 'directory_summary': {'declared_count': 16, 'declared_count_raw': 16, 'readable_count': 16, 'unprojected_count': 0}, 'module_match': 'resolved', 'observation_coverage': {'total': 29, 'consistent': 11, 'conflict': 0, 'unavailable': 3, 'not_applicable': 15}, 'sections': [{'section_index': 0, 'name': '.text', 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_raw_data': 8192, 'characteristics': 1610612736, 'declared_readable': True, 'declared_writable': False, 'declared_executable': True, 'mapped_base_address': '0x00007ff600011000', 'mapped_size': 8192, 'capture_state': 'none', 'live_protections': []}], 'directories': [{'index': 0, 'name': 'EXPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 1, 'name': 'IMPORT', 'value': 8192, 'value_kind': 'rva', 'size': 40, 'bytes_read': 8, 'present': True, 'descriptor_state': 'complete', 'containing_section_index': 0, 'capture_state': 'complete'}, {'index': 2, 'name': 'RESOURCE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 3, 'name': 'EXCEPTION', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 4, 'name': 'SECURITY', 'value': 0, 'value_kind': 'file_offset', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 5, 'name': 'BASERELOC', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 6, 'name': 'DEBUG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 7, 'name': 'ARCHITECTURE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 8, 'name': 'GLOBALPTR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 9, 'name': 'TLS', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 10, 'name': 'LOAD_CONFIG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 11, 'name': 'BOUND_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 12, 'name': 'IAT', 'value': 12288, 'value_kind': 'rva', 'size': 16, 'bytes_read': 8, 'present': True, 'descriptor_state': 'complete', 'containing_section_index': None, 'capture_state': 'complete'}, {'index': 13, 'name': 'DELAY_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 14, 'name': 'COM_DESCRIPTOR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 15, 'name': 'RESERVED', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}], 'observations': [{'name': 'base_vs_preferred', 'state': 'consistent', 'reason': 'delta_recorded', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'actual_base': 140694538747904, 'preferred_image_base': 140694538747904, 'relocation_delta': 0}}, {'name': 'relocation_expected', 'state': 'consistent', 'reason': 'zero_delta', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'relocation_delta': 0, 'relocs_stripped': False, 'basereloc_present': False}}, {'name': 'machine_vs_format', 'state': 'consistent', 'reason': 'format_matches_machine', 'sources': ['profile.coff_header', 'profile.optional_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64', 'is_pe32_plus': True}}, {'name': 'entry_point_in_section', 'state': 'consistent', 'reason': 'entry_point_in_decoded_section', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'address_of_entry_point': 4096, 'section_table_state': 'complete', 'containing_section_index': 0}}, {'name': 'size_vs_image_extent', 'state': 'unavailable', 'reason': 'regions_unavailable', 'sources': ['profile.source:peb_image_base', 'profile.optional_header', 'memory_info'], 'operands': {'size_of_image': 24576}}, {'name': 'size_vs_modulelist', 'state': 'consistent', 'reason': 'size_matches_modulelist', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'size_of_image': 24576, 'modulelist_size': 24576, 'section_alignment': 0}}, {'name': 'size_vs_section_extent', 'state': 'consistent', 'reason': 'size_covers_section_extent', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'size_of_image': 24576, 'section_table_state': 'complete', 'section_extent': 12288}}, {'name': 'identity_time_date_stamp', 'state': 'unavailable', 'reason': 'operand_null', 'sources': ['profile.coff_header', 'module_list'], 'operands': {'header_value': 305419896, 'module_list_value': None}}, {'name': 'identity_check_sum', 'state': 'not_applicable', 'reason': 'header_checksum_absent', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'header_value': 0, 'module_list_value': None}}, {'name': 'identity_machine', 'state': 'unavailable', 'reason': 'machine_no_independent_source', 'sources': ['profile.coff_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64'}}, {'name': 'section_range_overflow', 'state': 'consistent', 'reason': 'section_range_representable', 'sources': ['profile.source:peb_image_base', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'actual_base': 140694538747904}}, {'name': 'section_image_bound', 'state': 'consistent', 'reason': 'section_within_image_bound', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_image': 24576}}, {'name': 'section_overlap', 'state': 'consistent', 'reason': 'section_disjoint_from_others', 'sources': ['profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 0, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'consistent', 'reason': 'directory_within_image_bound', 'sources': ['profile.optional_header', 'profile.directory_descriptors'], 'operands': {'index': 1, 'value': 8192, 'size': 40, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 2, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 3, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'file_offset_semantics', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 4, 'value': 0, 'size': 0, 'value_kind': 'file_offset'}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 5, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 6, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 7, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 8, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 9, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 10, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 11, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'consistent', 'reason': 'directory_within_image_bound', 'sources': ['profile.optional_header', 'profile.directory_descriptors'], 'operands': {'index': 12, 'value': 12288, 'size': 16, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 13, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 14, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 15, 'value': 0, 'size': 0, 'size_of_image': 24576}}]}}]}},
    ),
    (
        'process_complete_verbose', ['--process', '--verbose'], _process_complete, 0,
        '\n═══ PROCESS ═══\n\n  Process Name           malware.exe\n  PID                    4242 (0x1092)\n  Path                   C:\\Samples\\malware.exe\n  Command Line           "C:\\Samples\\malware.exe" -k\n  Start Time (UTC)       2026-08-14 01:15:05 UTC\n  Image Base             0x00007ff600010000\n\n  Main Image PE\n    Architecture     AMD64 / PE32+\n    Actual Base      0x00007ff600010000\n    Preferred Base   0x00007ff600010000\n    Relocation       not required -- loaded at the preferred base\n    Image Size       0x6000 (24576 bytes), 1 section(s)\n    Entry Point      RVA 0x1000 -> 0x00007ff600011000 (.text; capture none)\n    Loader Record    a module is registered at this image base\n    Structure        complete -- every header structure was read in full\n    Consistency      11 consistent, 0 conflicting, 3 unavailable, 15 not applicable\n    Scope            structural main-image checks only; this does not establish\n                     that the process is benign\n    [??] image size vs. mapped memory: unavailable -- no usable memory region table, so the mapping this image occupies could not be established\n    [??] the dump\'s memory region table is not in this dump -- see Header Acquisition below\n\n    Sections                                     [--verbose only]\n      #   Name        RVA+Size            Mapped At             R/W/X  Live Protection         Capture\n      0   .text       0x1000+0x2000       0x00007ff600011000    R-X    (none recorded)         none\n      R/W/X is what the section header declares; Live Protection is what the dump recorded\n      for the memory it is mapped over. PAGE_EXECUTE_WRITECOPY is ordinary loader context.\n\n    Data Directories                             [--verbose only]\n      #   Directory         Presence        Value+Size          Addressing   Descriptor        Capture\n      0   EXPORT            absent          0x0+0x0             image RVA    declared absent   (n/a)\n      1   IMPORT            declared        0x2000+0x28         image RVA    complete          complete\n      2   RESOURCE          absent          0x0+0x0             image RVA    declared absent   (n/a)\n      3   EXCEPTION         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      4   SECURITY          absent          0x0+0x0             file offset  declared absent   (n/a)\n      5   BASERELOC         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      6   DEBUG             absent          0x0+0x0             image RVA    declared absent   (n/a)\n      7   ARCHITECTURE      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      8   GLOBALPTR         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      9   TLS               absent          0x0+0x0             image RVA    declared absent   (n/a)\n      10  LOAD_CONFIG       absent          0x0+0x0             image RVA    declared absent   (n/a)\n      11  BOUND_IMPORT      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      12  IAT               declared        0x3000+0x10         image RVA    complete          complete\n      13  DELAY_IMPORT      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      14  COM_DESCRIPTOR    absent          0x0+0x0             image RVA    declared absent   (n/a)\n      15  RESERVED          absent          0x0+0x0             image RVA    declared absent   (n/a)\n      Value+Size is the descriptor\'s own declaration; Addressing says whether that value is\n      an image RVA or a file offset. Descriptor is how much of the descriptor itself was read.\n\n    Relocation Evidence                          [--verbose only]\n      Distance                 none -- loaded at the preferred base\n      Stripped                 the header does not declare relocations stripped\n      Dynamic base             the header does not opt in to being loaded anywhere\n      Directory                the image declares no base-relocation directory\n      Descriptor               declared absent\n\n    Consistency Checks                           [--verbose only]\n      [OK] load address vs. preferred base: the load address and the preferred base are both recorded\n           evidence: the PEB-reported image base, the image\'s optional header\n      [OK] relocation evidence: the image is loaded at its preferred base, so no relocation was needed\n           evidence: the PEB-reported image base, the image\'s optional header\n      [OK] architecture vs. header format: the header format is the one this architecture fixes\n           evidence: the image\'s COFF header, the image\'s optional header\n      [OK] entry point placement: the entry point falls inside a decoded section\n           evidence: the image\'s optional header, the image\'s section table\n      [??] image size vs. mapped memory: unavailable -- no usable memory region table, so the mapping this image occupies could not be established\n           evidence: the PEB-reported image base, the image\'s optional header, the dump\'s memory region table\n      [OK] image size vs. loader record: the declared image size matches the loader\'s own record\n           evidence: the image\'s optional header, the loader\'s module list\n      [OK] image size vs. section table: every decoded section fits inside the declared image size\n           evidence: the image\'s optional header, the image\'s section table\n      [??] timestamp vs. loader record: unavailable -- one of the two values was not recorded\n           evidence: the image\'s COFF header, the loader\'s module list\n      [--] checksum vs. loader record: not applicable -- the header carries no checksum, which is ordinary for a linked image\n           evidence: the image\'s optional header, the loader\'s module list\n      [??] architecture vs. a second source: unavailable -- the dump carries no second source for this image\'s architecture\n           evidence: the image\'s COFF header\n      [OK] section 0 (.text): the section\'s address range is representable at this load address\n           evidence: the PEB-reported image base, the image\'s section table\n      [OK] section 0 (.text): the section fits inside the declared image size\n           evidence: the image\'s optional header, the image\'s section table\n      [OK] section 0 (.text): the section shares no address with another section\n           evidence: the image\'s section table\n      [--] directory 0 (EXPORT): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [OK] directory 1 (IMPORT): the directory fits inside the declared image size\n           evidence: the image\'s optional header, the image\'s data directory descriptors\n      [--] directory 2 (RESOURCE): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 3 (EXCEPTION): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 4 (SECURITY): not applicable -- this directory is addressed by file offset, not by image RVA, so it is not part of the mapping\n           evidence: the image\'s data directory descriptors\n      [--] directory 5 (BASERELOC): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 6 (DEBUG): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 7 (ARCHITECTURE): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 8 (GLOBALPTR): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 9 (TLS): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 10 (LOAD_CONFIG): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 11 (BOUND_IMPORT): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [OK] directory 12 (IAT): the directory fits inside the declared image size\n           evidence: the image\'s optional header, the image\'s data directory descriptors\n      [--] directory 13 (DELAY_IMPORT): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 14 (COM_DESCRIPTOR): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n      [--] directory 15 (RESERVED): not applicable -- the image declares this directory absent\n           evidence: the image\'s data directory descriptors\n\n    Header Acquisition                           [--verbose only]\n      Requested window         0x1000 bytes at the image base\n      Captured in that window  0x3b0 bytes\n      Required for parsing     0x1b0 bytes\n      Required bytes present   yes\n      Segment table            walked in full\n      Region table             not in this dump\n                               the dump\'s memory region table is not in this dump: any check or context that needed the table is withheld, not decided\n      Parsing                  completed through the section table, as requested\n      Header components        read in full: DOS header, COFF header, optional header, directory array, directory descriptors, section table\n      Named as                 C:\\Samples\\malware.exe (path from the PEB-reported image base)\n\n  Import Address Table\n    1 import(s) across 1 DLL(s)\n\n    Each row reads IAT Slot VA -> Resolved Target VA.\n    The slot is the address where the import pointer is stored; the target is the\n    address stored in that slot in the captured process memory.\n\n    DLL                       Imported API                  IAT Slot VA           Resolved Target VA\n    KERNEL32.dll              CreateFileW                   0x00007ff600013000    0x00007ffb12345678\n\n  Identity Verification                            [--verbose only]\n    Selected path    C:\\Samples\\malware.exe\n    Selected name    malware.exe\n    Source           PEB (ProcessParameters.ImagePathName)\n    Image base       0x00007ff600010000 (source: PEB)\n\n    [OK] PEB image base is registered in ModuleList\n         0x00007ff600010000 -> malware.exe\n    [OK] PEB and ModuleList process names agree\n    [OK] a valid PE header was found at the PEB image base\n    [OK] no competing module shares this process name\n\n    Raw claims       PEB                              ModuleList\n    path             C:\\Samples\\malware.exe           C:\\Samples\\malware.exe\n    name             malware.exe                      malware.exe\n    image base       0x00007ff600010000               0x00007ff600010000 (resolved)\n\n  Extended PEB\n    PEB Address        0x0000000000000000\n    BeingDebugged      False\n    WindowTitle        (none)\n    DllPath            (none)\n    StandardInput      (unknown)\n    StandardOutput     (unknown)\n    StandardError      (unknown)\n',
        {'kind': 'process', 'execution_status': 'completed', 'coverage': {'status': 'complete', 'reasons': [], 'sources': {'process_identity': {'state': 'present', 'record_count': 5, 'detail': None}, 'misc_info': {'state': 'present', 'record_count': 1, 'detail': None}, 'peb': {'state': 'present', 'record_count': 1, 'detail': None}, 'modules': {'state': 'present', 'record_count': 1, 'detail': None}, 'main_image': {'state': 'present', 'record_count': 1, 'detail': None}, 'iat': {'state': 'present', 'record_count': 1, 'detail': None}}, 'limitations': []}, 'summary': {'count': 1}, 'data': {'records': [{'process_name': 'malware.exe', 'pid': 4242, 'process_path': 'C:\\Samples\\malware.exe', 'command_line': '"C:\\Samples\\malware.exe" -k', 'process_start_utc': '2026-08-14 01:15:05 UTC', 'image_base_address': '0x00007ff600010000', 'iat': {'table_present': True, 'table_va': '0x00007ff600013000', 'table_size': 16, 'import_directory_present': True, 'import_directory_va': '0x00007ff600012000', 'import_directory_size': 40, 'has_entries': True, 'dll_count': 1, 'entry_count': 1, 'entries': [{'dll': 'KERNEL32.dll', 'import_by': 'name', 'symbol': 'CreateFileW', 'ordinal': None, 'iat_slot_va': '0x00007ff600013000', 'resolved_target_va': '0x00007ffb12345678', 'slot_in_bounds': True}], 'diagnostics': []}, 'identity_evidence': {'misc_info_claim': {'pid': 4242, 'process_create_time_utc': '2026-08-14 01:15:05 UTC', 'raw_pid': None, 'raw_process_create_time': None}, 'peb_claim': {'image_base_address': '0x00007ff600010000', 'image_path': 'C:\\Samples\\malware.exe', 'name': 'malware.exe', 'raw_image_base_address': None, 'raw_image_path': None, 'raw_command_line': None}, 'module_claim': {'match_state': 'resolved', 'base_address': '0x00007ff600010000', 'name': 'malware.exe', 'path': 'C:\\Samples\\malware.exe', 'name_matched_candidate': None, 'name_matched_candidate_ambiguous': False}, 'main_image_pe': {'checked': True, 'valid': True, 'reason': None}, 'selected_path_source': 'peb', 'diagnostics': []}, 'pe_image': {'collected': True, 'correlated': True, 'unavailable_reason': None, 'source_kind': 'peb_image_base', 'module_identity': {'value': 'C:\\Samples\\malware.exe', 'form': 'path', 'truncated': False}, 'actual_base': '0x00007ff600010000', 'preferred_image_base': '0x00007ff600010000', 'format': 'PE32+', 'machine': 34404, 'machine_name': 'AMD64', 'time_date_stamp': 305419896, 'checksum': 0, 'subsystem': 0, 'dll_characteristics': 0, 'coff_characteristics': 258, 'size_of_image': 24576, 'size_of_headers': 0, 'section_alignment': 0, 'file_alignment': 0, 'declared_section_count': 1, 'decoded_section_count': 1, 'structural_state': 'complete', 'relocation': {'delta': 0, 'relocs_stripped': False, 'dynamic_base': False, 'basereloc_present': False, 'basereloc_descriptor_state': 'declared_absent'}, 'entry_point': {'rva': 4096, 'va': '0x00007ff600011000', 'va_overflow': False, 'section_index': 0, 'section_name': '.text', 'capture_state': 'none', 'region_state': None, 'region_type': None, 'region_protection': None}, 'acquisition': {'requested_stage': 'sections', 'highest_completed_stage': 'sections', 'requested_bytes': 4096, 'captured_bytes': 944, 'read_bytes': 432, 'read_target_bytes': 432, 'target_io_short': False, 'bounded_stop': None, 'components': {'dos_header': 'complete', 'coff_header': 'complete', 'optional_header': 'complete', 'directory_array': 'complete', 'directory_descriptors': 'complete', 'section_table': 'complete'}, 'segment_table': 'enumerated', 'region_table': 'absent', 'capture_overlapping': False, 'unexamined': []}, 'directory_summary': {'declared_count': 16, 'declared_count_raw': 16, 'readable_count': 16, 'unprojected_count': 0}, 'module_match': 'resolved', 'observation_coverage': {'total': 29, 'consistent': 11, 'conflict': 0, 'unavailable': 3, 'not_applicable': 15}, 'sections': [{'section_index': 0, 'name': '.text', 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_raw_data': 8192, 'characteristics': 1610612736, 'declared_readable': True, 'declared_writable': False, 'declared_executable': True, 'mapped_base_address': '0x00007ff600011000', 'mapped_size': 8192, 'capture_state': 'none', 'live_protections': []}], 'directories': [{'index': 0, 'name': 'EXPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 1, 'name': 'IMPORT', 'value': 8192, 'value_kind': 'rva', 'size': 40, 'bytes_read': 8, 'present': True, 'descriptor_state': 'complete', 'containing_section_index': 0, 'capture_state': 'complete'}, {'index': 2, 'name': 'RESOURCE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 3, 'name': 'EXCEPTION', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 4, 'name': 'SECURITY', 'value': 0, 'value_kind': 'file_offset', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 5, 'name': 'BASERELOC', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 6, 'name': 'DEBUG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 7, 'name': 'ARCHITECTURE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 8, 'name': 'GLOBALPTR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 9, 'name': 'TLS', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 10, 'name': 'LOAD_CONFIG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 11, 'name': 'BOUND_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 12, 'name': 'IAT', 'value': 12288, 'value_kind': 'rva', 'size': 16, 'bytes_read': 8, 'present': True, 'descriptor_state': 'complete', 'containing_section_index': None, 'capture_state': 'complete'}, {'index': 13, 'name': 'DELAY_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 14, 'name': 'COM_DESCRIPTOR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 15, 'name': 'RESERVED', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}], 'observations': [{'name': 'base_vs_preferred', 'state': 'consistent', 'reason': 'delta_recorded', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'actual_base': 140694538747904, 'preferred_image_base': 140694538747904, 'relocation_delta': 0}}, {'name': 'relocation_expected', 'state': 'consistent', 'reason': 'zero_delta', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'relocation_delta': 0, 'relocs_stripped': False, 'basereloc_present': False}}, {'name': 'machine_vs_format', 'state': 'consistent', 'reason': 'format_matches_machine', 'sources': ['profile.coff_header', 'profile.optional_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64', 'is_pe32_plus': True}}, {'name': 'entry_point_in_section', 'state': 'consistent', 'reason': 'entry_point_in_decoded_section', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'address_of_entry_point': 4096, 'section_table_state': 'complete', 'containing_section_index': 0}}, {'name': 'size_vs_image_extent', 'state': 'unavailable', 'reason': 'regions_unavailable', 'sources': ['profile.source:peb_image_base', 'profile.optional_header', 'memory_info'], 'operands': {'size_of_image': 24576}}, {'name': 'size_vs_modulelist', 'state': 'consistent', 'reason': 'size_matches_modulelist', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'size_of_image': 24576, 'modulelist_size': 24576, 'section_alignment': 0}}, {'name': 'size_vs_section_extent', 'state': 'consistent', 'reason': 'size_covers_section_extent', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'size_of_image': 24576, 'section_table_state': 'complete', 'section_extent': 12288}}, {'name': 'identity_time_date_stamp', 'state': 'unavailable', 'reason': 'operand_null', 'sources': ['profile.coff_header', 'module_list'], 'operands': {'header_value': 305419896, 'module_list_value': None}}, {'name': 'identity_check_sum', 'state': 'not_applicable', 'reason': 'header_checksum_absent', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'header_value': 0, 'module_list_value': None}}, {'name': 'identity_machine', 'state': 'unavailable', 'reason': 'machine_no_independent_source', 'sources': ['profile.coff_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64'}}, {'name': 'section_range_overflow', 'state': 'consistent', 'reason': 'section_range_representable', 'sources': ['profile.source:peb_image_base', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'actual_base': 140694538747904}}, {'name': 'section_image_bound', 'state': 'consistent', 'reason': 'section_within_image_bound', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_image': 24576}}, {'name': 'section_overlap', 'state': 'consistent', 'reason': 'section_disjoint_from_others', 'sources': ['profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 0, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'consistent', 'reason': 'directory_within_image_bound', 'sources': ['profile.optional_header', 'profile.directory_descriptors'], 'operands': {'index': 1, 'value': 8192, 'size': 40, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 2, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 3, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'file_offset_semantics', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 4, 'value': 0, 'size': 0, 'value_kind': 'file_offset'}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 5, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 6, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 7, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 8, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 9, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 10, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 11, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'consistent', 'reason': 'directory_within_image_bound', 'sources': ['profile.optional_header', 'profile.directory_descriptors'], 'operands': {'index': 12, 'value': 12288, 'size': 16, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 13, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 14, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 15, 'value': 0, 'size': 0, 'size_of_image': 24576}}]}, 'peb_extended': {'peb_address': '0x0000000000000000', 'being_debugged': False, 'window_title': None, 'dll_path': None, 'standard_input': None, 'standard_output': None, 'standard_error': None}}]}},
    ),
    (
    ...
    (
        ...
        {'kind': 'process', 'execution_status': 'completed', 'coverage': {'status': 'partial', 'reasons': ['PEB present but CommandLine is empty', 'PEB present but ImageBaseAddress is not set'], 'sources': {'process_identity': {'state': 'present', 'record_count': 3, 'detail': None}, 'misc_info': {'state': 'present', 'record_count': 1, 'detail': None}, 'peb': {'state': 'present', 'record_count': 1, 'detail': None}, 'modules': {'state': 'absent', 'record_count': None, 'detail': None}, 'main_image': {'state': 'absent', 'record_count': None, 'detail': None}, 'iat': {'state': 'absent', 'record_count': None, 'detail': None}}, 'limitations': [{'code': 'PROCESS_COMMAND_LINE_UNAVAILABLE', 'source': 'peb', 'scope': None, 'affected_count': None, 'unavailable_fields': [], 'available_fields': [], 'counterpart_source': None, 'related_sources': [], 'related_tids': [], 'thread_id': None, 'detail': None, 'targets': [], 'budget_limit': None, 'budget_consumed': None}, {'code': 'PROCESS_IMAGE_BASE_UNAVAILABLE', 'source': 'peb', 'scope': None, 'affected_count': None, 'unavailable_fields': [], 'available_fields': [], 'counterpart_source': None, 'related_sources': [], 'related_tids': [], 'thread_id': None, 'detail': None, 'targets': [], 'budget_limit': None, 'budget_consumed': None}]}, 'summary': {'count': 1}, 'data': {'records': [{'process_name': 'test.exe', 'pid': 100, 'process_path': 'C:\\test.exe', 'command_line': None, 'process_start_utc': '2026-08-14 01:15:05 UTC', 'image_base_address': None, 'iat': {'table_present': None, 'table_va': None, 'table_size': None, 'import_directory_present': None, 'import_directory_va': None, 'import_directory_size': None, 'has_entries': False, 'dll_count': 0, 'entry_count': 0, 'entries': [], 'diagnostics': []}, 'identity_evidence': {'misc_info_claim': {'pid': 100, 'process_create_time_utc': '2026-08-14 01:15:05 UTC', 'raw_pid': None, 'raw_process_create_time': None}, 'peb_claim': {'image_base_address': None, 'image_path': 'C:\\test.exe', 'name': 'test.exe', 'raw_image_base_address': None, 'raw_image_path': None, 'raw_command_line': None}, 'module_claim': {'match_state': 'unavailable', 'base_address': None, 'name': None, 'path': None, 'name_matched_candidate': None, 'name_matched_candidate_ambiguous': False}, 'main_image_pe': {'checked': False, 'valid': None, 'reason': None}, 'selected_path_source': 'peb', 'diagnostics': []}, 'pe_image': {'collected': False, 'correlated': False, 'unavailable_reason': 'no_image_base', 'source_kind': None, 'module_identity': {'value': None, 'form': None, 'truncated': False}, 'actual_base': None, 'preferred_image_base': None, 'format': None, 'machine': None, 'machine_name': None, 'time_date_stamp': None, 'checksum': None, 'subsystem': None, 'dll_characteristics': None, 'coff_characteristics': None, 'size_of_image': None, 'size_of_headers': None, 'section_alignment': None, 'file_alignment': None, 'declared_section_count': None, 'decoded_section_count': 0, 'structural_state': None, 'relocation': {'delta': None, 'relocs_stripped': None, 'dynamic_base': None, 'basereloc_present': None, 'basereloc_descriptor_state': None}, 'entry_point': {'rva': None, 'va': None, 'va_overflow': False, 'section_index': None, 'section_name': None, 'capture_state': None, 'region_state': None, 'region_type': None, 'region_protection': None}, 'acquisition': None, 'directory_summary': {'declared_count': None, 'declared_count_raw': None, 'readable_count': None, 'unprojected_count': None}, 'module_match': None, 'observation_coverage': {'total': 0, 'consistent': 0, 'conflict': 0, 'unavailable': 0, 'not_applicable': 0}, 'sections': [], 'directories': [], 'observations': []}}]}},
    ),
    (
        'process_verbose_unavailable_identity_checks', ['--process', '--verbose'], _process_unavailable_checks, 0,
        "\n═══ PROCESS ═══\n\n  Process Name           malware.exe\n  PID                    4242 (0x1092)\n  Path                   C:\\Samples\\malware.exe\n  Command Line           C:\\Samples\\malware.exe\n  Start Time (UTC)       2026-08-14 01:15:05 UTC\n  Image Base             0x00007ff600010000\n\n  Main Image PE\n    Architecture     AMD64 / PE32+\n    Actual Base      0x00007ff600010000\n    Preferred Base   0x00007ff600010000\n    Relocation       not required -- loaded at the preferred base\n    Image Size       0x6000 (24576 bytes), 1 section(s)\n    Entry Point      RVA 0x1000 -> 0x00007ff600011000 (.text; capture none)\n    Loader Record    the loader's module list could not be compared with this image base\n    Structure        complete -- every header structure was read in full\n    Consistency      8 consistent, 0 conflicting, 4 unavailable, 17 not applicable\n    Scope            structural main-image checks only; this does not establish\n                     that the process is benign\n    [??] image size vs. mapped memory: unavailable -- no usable memory region table, so the mapping this image occupies could not be established\n    [??] image size vs. loader record: unavailable -- no loader module record was matched at this image base (see the loader record line above for whether one could be)\n    [??] the dump's memory region table is not in this dump -- see Header Acquisition below\n\n    Sections                                     [--verbose only]\n      #   Name        RVA+Size            Mapped At             R/W/X  Live Protection         Capture\n      0   .text       0x1000+0x2000       0x00007ff600011000    R-X    (none recorded)         none\n      R/W/X is what the section header declares; Live Protection is what the dump recorded\n      for the memory it is mapped over. PAGE_EXECUTE_WRITECOPY is ordinary loader context.\n\n    Data Directories                             [--verbose only]\n      #   Directory         Presence        Value+Size          Addressing   Descriptor        Capture\n      0   EXPORT            absent          0x0+0x0             image RVA    declared absent   (n/a)\n      1   IMPORT            absent          0x0+0x0             image RVA    declared absent   (n/a)\n      2   RESOURCE          absent          0x0+0x0             image RVA    declared absent   (n/a)\n      3   EXCEPTION         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      4   SECURITY          absent          0x0+0x0             file offset  declared absent   (n/a)\n      5   BASERELOC         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      6   DEBUG             absent          0x0+0x0             image RVA    declared absent   (n/a)\n      7   ARCHITECTURE      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      8   GLOBALPTR         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      9   TLS               absent          0x0+0x0             image RVA    declared absent   (n/a)\n      10  LOAD_CONFIG       absent          0x0+0x0             image RVA    declared absent   (n/a)\n      11  BOUND_IMPORT      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      12  IAT               absent          0x0+0x0             image RVA    declared absent   (n/a)\n      13  DELAY_IMPORT      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      14  COM_DESCRIPTOR    absent          0x0+0x0             image RVA    declared absent   (n/a)\n      15  RESERVED          absent          0x0+0x0             image RVA    declared absent   (n/a)\n      Value+Size is the descriptor's own declaration; Addressing says whether that value is\n      an image RVA or a file offset. Descriptor is how much of the descriptor itself was read.\n\n    Relocation Evidence                          [--verbose only]\n      Distance                 none -- loaded at the preferred base\n      Stripped                 the header does not declare relocations stripped\n      Dynamic base             the header does not opt in to being loaded anywhere\n      Directory                the image declares no base-relocation directory\n      Descriptor               declared absent\n\n    Consistency Checks                           [--verbose only]\n      [OK] load address vs. preferred base: the load address and the preferred base are both recorded\n           evidence: the PEB-reported image base, the image's optional header\n      [OK] relocation evidence: the image is loaded at its preferred base, so no relocation was needed\n           evidence: the PEB-reported image base, the image's optional header\n      [OK] architecture vs. header format: the header format is the one this architecture fixes\n           evidence: the image's COFF header, the image's optional header\n      [OK] entry point placement: the entry point falls inside a decoded section\n           evidence: the image's optional header, the image's section table\n      [??] image size vs. mapped memory: unavailable -- no usable memory region table, so the mapping this image occupies could not be established\n           evidence: the PEB-reported image base, the image's optional header, the dump's memory region table\n      [??] image size vs. loader record: unavailable -- no loader module record was matched at this image base (see the loader record line above for whether one could be)\n           evidence: the image's optional header, the loader's module list\n      [OK] image size vs. section table: every decoded section fits inside the declared image size\n           evidence: the image's optional header, the image's section table\n      [??] timestamp vs. loader record: unavailable -- no loader module record was matched at this image base to compare against\n           evidence: the image's COFF header, the loader's module list\n      [--] checksum vs. loader record: not applicable -- the header carries no checksum, which is ordinary for a linked image\n           evidence: the image's optional header, the loader's module list\n      [??] architecture vs. a second source: unavailable -- the dump carries no second source for this image's architecture\n           evidence: the image's COFF header\n      [OK] section 0 (.text): the section's address range is representable at this load address\n           evidence: the PEB-reported image base, the image's section table\n      [OK] section 0 (.text): the section fits inside the declared image size\n           evidence: the image's optional header, the image's section table\n      [OK] section 0 (.text): the section shares no address with another section\n           evidence: the image's section table\n      [--] directory 0 (EXPORT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 1 (IMPORT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 2 (RESOURCE): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 3 (EXCEPTION): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 4 (SECURITY): not applicable -- this directory is addressed by file offset, not by image RVA, so it is not part of the mapping\n           evidence: the image's data directory descriptors\n      [--] directory 5 (BASERELOC): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 6 (DEBUG): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 7 (ARCHITECTURE): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 8 (GLOBALPTR): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 9 (TLS): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 10 (LOAD_CONFIG): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 11 (BOUND_IMPORT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 12 (IAT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 13 (DELAY_IMPORT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 14 (COM_DESCRIPTOR): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 15 (RESERVED): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n\n    Header Acquisition                           [--verbose only]\n      Requested window         0x1000 bytes at the image base\n      Captured in that window  0x3b0 bytes\n      Required for parsing     0x1b0 bytes\n      Required bytes present   yes\n      Segment table            walked in full\n      Region table             not in this dump\n                               the dump's memory region table is not in this dump: any check or context that needed the table is withheld, not decided\n      Parsing                  completed through the section table, as requested\n      Header components        read in full: DOS header, COFF header, optional header, directory array, directory descriptors, section table\n      Named as                 C:\\Samples\\malware.exe (path from the PEB-reported image base)\n\n  Import Address Table\n    (none -- this image declares no imports)\n\n  Identity Verification                            [--verbose only]\n    Selected path    C:\\Samples\\malware.exe\n    Selected name    malware.exe\n    Source           PEB (ProcessParameters.ImagePathName)\n    Image base       0x00007ff600010000 (source: PEB)\n\n    [??] PEB image base could not be compared with ModuleList\n         ModuleListStream is absent or failed, or no image base normalized\n    [??] PEB and ModuleList process names could not be compared\n         one of the two names was not recovered\n    [OK] a valid PE header was found at the PEB image base\n    [??] no ModuleList corroboration was available for this identity\n\n    Raw claims       PEB                              ModuleList\n    path             C:\\Samples\\malware.exe           (none)\n    name             malware.exe                      (none)\n    image base       0x00007ff600010000               (none) (unavailable)\n\n  Extended PEB\n    PEB Address        0x0000000000000000\n    BeingDebugged      False\n    WindowTitle        (none)\n    DllPath            (none)\n    StandardInput      (unknown)\n    StandardOutput     (unknown)\n    StandardError      (unknown)\n",
        {'kind': 'process', 'execution_status': 'completed', 'coverage': {'status': 'complete', 'reasons': [], 'sources': {'process_identity': {'state': 'present', 'record_count': 5, 'detail': None}, 'misc_info': {'state': 'present', 'record_count': 1, 'detail': None}, 'peb': {'state': 'present', 'record_count': 1, 'detail': None}, 'modules': {'state': 'absent', 'record_count': None, 'detail': None}, 'main_image': {'state': 'present', 'record_count': 1, 'detail': None}, 'iat': {'state': 'present_empty', 'record_count': 0, 'detail': None}}, 'limitations': []}, 'summary': {'count': 1}, 'data': {'records': [{'process_name': 'malware.exe', 'pid': 4242, 'process_path': 'C:\\Samples\\malware.exe', 'command_line': 'C:\\Samples\\malware.exe', 'process_start_utc': '2026-08-14 01:15:05 UTC', 'image_base_address': '0x00007ff600010000', 'iat': {'table_present': False, 'table_va': None, 'table_size': None, 'import_directory_present': False, 'import_directory_va': None, 'import_directory_size': None, 'has_entries': False, 'dll_count': 0, 'entry_count': 0, 'entries': [], 'diagnostics': []}, 'identity_evidence': {'misc_info_claim': {'pid': 4242, 'process_create_time_utc': '2026-08-14 01:15:05 UTC', 'raw_pid': None, 'raw_process_create_time': None}, 'peb_claim': {'image_base_address': '0x00007ff600010000', 'image_path': 'C:\\Samples\\malware.exe', 'name': 'malware.exe', 'raw_image_base_address': None, 'raw_image_path': None, 'raw_command_line': None}, 'module_claim': {'match_state': 'unavailable', 'base_address': None, 'name': None, 'path': None, 'name_matched_candidate': None, 'name_matched_candidate_ambiguous': False}, 'main_image_pe': {'checked': True, 'valid': True, 'reason': None}, 'selected_path_source': 'peb', 'diagnostics': []}, 'pe_image': {'collected': True, 'correlated': True, 'unavailable_reason': None, 'source_kind': 'peb_image_base', 'module_identity': {'value': 'C:\\Samples\\malware.exe', 'form': 'path', 'truncated': False}, 'actual_base': '0x00007ff600010000', 'preferred_image_base': '0x00007ff600010000', 'format': 'PE32+', 'machine': 34404, 'machine_name': 'AMD64', 'time_date_stamp': 305419896, 'checksum': 0, 'subsystem': 0, 'dll_characteristics': 0, 'coff_characteristics': 258, 'size_of_image': 24576, 'size_of_headers': 0, 'section_alignment': 0, 'file_alignment': 0, 'declared_section_count': 1, 'decoded_section_count': 1, 'structural_state': 'complete', 'relocation': {'delta': 0, 'relocs_stripped': False, 'dynamic_base': False, 'basereloc_present': False, 'basereloc_descriptor_state': 'declared_absent'}, 'entry_point': {'rva': 4096, 'va': '0x00007ff600011000', 'va_overflow': False, 'section_index': 0, 'section_name': '.text', 'capture_state': 'none', 'region_state': None, 'region_type': None, 'region_protection': None}, 'acquisition': {'requested_stage': 'sections', 'highest_completed_stage': 'sections', 'requested_bytes': 4096, 'captured_bytes': 944, 'read_bytes': 432, 'read_target_bytes': 432, 'target_io_short': False, 'bounded_stop': None, 'components': {'dos_header': 'complete', 'coff_header': 'complete', 'optional_header': 'complete', 'directory_array': 'complete', 'directory_descriptors': 'complete', 'section_table': 'complete'}, 'segment_table': 'enumerated', 'region_table': 'absent', 'capture_overlapping': False, 'unexamined': []}, 'directory_summary': {'declared_count': 16, 'declared_count_raw': 16, 'readable_count': 16, 'unprojected_count': 0}, 'module_match': 'unavailable', 'observation_coverage': {'total': 29, 'consistent': 8, 'conflict': 0, 'unavailable': 4, 'not_applicable': 17}, 'sections': [{'section_index': 0, 'name': '.text', 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_raw_data': 8192, 'characteristics': 1610612736, 'declared_readable': True, 'declared_writable': False, 'declared_executable': True, 'mapped_base_address': '0x00007ff600011000', 'mapped_size': 8192, 'capture_state': 'none', 'live_protections': []}], 'directories': [{'index': 0, 'name': 'EXPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 1, 'name': 'IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 2, 'name': 'RESOURCE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 3, 'name': 'EXCEPTION', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 4, 'name': 'SECURITY', 'value': 0, 'value_kind': 'file_offset', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 5, 'name': 'BASERELOC', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 6, 'name': 'DEBUG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 7, 'name': 'ARCHITECTURE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 8, 'name': 'GLOBALPTR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 9, 'name': 'TLS', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 10, 'name': 'LOAD_CONFIG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 11, 'name': 'BOUND_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 12, 'name': 'IAT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 13, 'name': 'DELAY_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 14, 'name': 'COM_DESCRIPTOR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 15, 'name': 'RESERVED', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}], 'observations': [{'name': 'base_vs_preferred', 'state': 'consistent', 'reason': 'delta_recorded', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'actual_base': 140694538747904, 'preferred_image_base': 140694538747904, 'relocation_delta': 0}}, {'name': 'relocation_expected', 'state': 'consistent', 'reason': 'zero_delta', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'relocation_delta': 0, 'relocs_stripped': False, 'basereloc_present': False}}, {'name': 'machine_vs_format', 'state': 'consistent', 'reason': 'format_matches_machine', 'sources': ['profile.coff_header', 'profile.optional_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64', 'is_pe32_plus': True}}, {'name': 'entry_point_in_section', 'state': 'consistent', 'reason': 'entry_point_in_decoded_section', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'address_of_entry_point': 4096, 'section_table_state': 'complete', 'containing_section_index': 0}}, {'name': 'size_vs_image_extent', 'state': 'unavailable', 'reason': 'regions_unavailable', 'sources': ['profile.source:peb_image_base', 'profile.optional_header', 'memory_info'], 'operands': {'size_of_image': 24576}}, {'name': 'size_vs_modulelist', 'state': 'unavailable', 'reason': 'no_modulelist_entry', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'size_of_image': 24576, 'modulelist_size': None}}, {'name': 'size_vs_section_extent', 'state': 'consistent', 'reason': 'size_covers_section_extent', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'size_of_image': 24576, 'section_table_state': 'complete', 'section_extent': 12288}}, {'name': 'identity_time_date_stamp', 'state': 'unavailable', 'reason': 'no_second_source', 'sources': ['profile.coff_header', 'module_list'], 'operands': {'header_value': 305419896, 'module_list_value': None}}, {'name': 'identity_check_sum', 'state': 'not_applicable', 'reason': 'header_checksum_absent', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'header_value': 0, 'module_list_value': None}}, {'name': 'identity_machine', 'state': 'unavailable', 'reason': 'machine_no_independent_source', 'sources': ['profile.coff_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64'}}, {'name': 'section_range_overflow', 'state': 'consistent', 'reason': 'section_range_representable', 'sources': ['profile.source:peb_image_base', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'actual_base': 140694538747904}}, {'name': 'section_image_bound', 'state': 'consistent', 'reason': 'section_within_image_bound', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_image': 24576}}, {'name': 'section_overlap', 'state': 'consistent', 'reason': 'section_disjoint_from_others', 'sources': ['profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 0, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 1, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 2, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 3, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'file_offset_semantics', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 4, 'value': 0, 'size': 0, 'value_kind': 'file_offset'}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 5, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 6, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 7, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 8, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 9, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 10, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 11, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 12, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 13, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 14, 'value': 0, 'size': 0, 'size_of_image': 24576}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 15, 'value': 0, 'size': 0, 'size_of_image': 24576}}]}, 'peb_extended': {'peb_address': '0x0000000000000000', 'being_debugged': False, 'window_title': None, 'dll_path': None, 'standard_input': None, 'standard_output': None, 'standard_error': None}}]}},
    ),
    (
        'process_verbose_conflict_and_iat_variety', ['--process', '--verbose'], _process_conflict_and_iat, 0,
        "\n═══ PROCESS ═══\n\n  Process Name           malware.exe\n  PID                    4242 (0x1092)\n  Path                   C:\\Samples\\malware.exe\n  Command Line           C:\\Samples\\malware.exe\n  Start Time (UTC)       2026-08-14 01:15:05 UTC\n  Image Base             0x00007ff600010000\n\n  Main Image PE\n    Architecture     AMD64 / PE32+\n    Actual Base      0x00007ff600010000\n    Preferred Base   0x00007ff600010000\n    Relocation       not required -- loaded at the preferred base\n    Image Size       0x7000 (28672 bytes), 1 section(s)\n    Entry Point      RVA 0x1000 -> 0x00007ff600011000 (.text; capture none)\n    Loader Record    no module is registered at this image base (the loader's list was read)\n    Structure        complete -- every header structure was read in full\n    Consistency      10 consistent, 0 conflicting, 4 unavailable, 15 not applicable\n    Scope            structural main-image checks only; this does not establish\n                     that the process is benign\n    [??] image size vs. mapped memory: unavailable -- no usable memory region table, so the mapping this image occupies could not be established\n    [??] image size vs. loader record: unavailable -- no loader module record was matched at this image base (see the loader record line above for whether one could be)\n    [??] the dump's memory region table is not in this dump -- see Header Acquisition below\n\n    Sections                                     [--verbose only]\n      #   Name        RVA+Size            Mapped At             R/W/X  Live Protection         Capture\n      0   .text       0x1000+0x2000       0x00007ff600011000    R-X    (none recorded)         none\n      R/W/X is what the section header declares; Live Protection is what the dump recorded\n      for the memory it is mapped over. PAGE_EXECUTE_WRITECOPY is ordinary loader context.\n\n    Data Directories                             [--verbose only]\n      #   Directory         Presence        Value+Size          Addressing   Descriptor        Capture\n      0   EXPORT            absent          0x0+0x0             image RVA    declared absent   (n/a)\n      1   IMPORT            declared        0x2000+0x3c         image RVA    complete          complete\n      2   RESOURCE          absent          0x0+0x0             image RVA    declared absent   (n/a)\n      3   EXCEPTION         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      4   SECURITY          absent          0x0+0x0             file offset  declared absent   (n/a)\n      5   BASERELOC         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      6   DEBUG             absent          0x0+0x0             image RVA    declared absent   (n/a)\n      7   ARCHITECTURE      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      8   GLOBALPTR         absent          0x0+0x0             image RVA    declared absent   (n/a)\n      9   TLS               absent          0x0+0x0             image RVA    declared absent   (n/a)\n      10  LOAD_CONFIG       absent          0x0+0x0             image RVA    declared absent   (n/a)\n      11  BOUND_IMPORT      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      12  IAT               declared        0x3000+0x20         image RVA    complete          complete\n      13  DELAY_IMPORT      absent          0x0+0x0             image RVA    declared absent   (n/a)\n      14  COM_DESCRIPTOR    absent          0x0+0x0             image RVA    declared absent   (n/a)\n      15  RESERVED          absent          0x0+0x0             image RVA    declared absent   (n/a)\n      Value+Size is the descriptor's own declaration; Addressing says whether that value is\n      an image RVA or a file offset. Descriptor is how much of the descriptor itself was read.\n\n    Relocation Evidence                          [--verbose only]\n      Distance                 none -- loaded at the preferred base\n      Stripped                 the header does not declare relocations stripped\n      Dynamic base             the header does not opt in to being loaded anywhere\n      Directory                the image declares no base-relocation directory\n      Descriptor               declared absent\n\n    Consistency Checks                           [--verbose only]\n      [OK] load address vs. preferred base: the load address and the preferred base are both recorded\n           evidence: the PEB-reported image base, the image's optional header\n      [OK] relocation evidence: the image is loaded at its preferred base, so no relocation was needed\n           evidence: the PEB-reported image base, the image's optional header\n      [OK] architecture vs. header format: the header format is the one this architecture fixes\n           evidence: the image's COFF header, the image's optional header\n      [OK] entry point placement: the entry point falls inside a decoded section\n           evidence: the image's optional header, the image's section table\n      [??] image size vs. mapped memory: unavailable -- no usable memory region table, so the mapping this image occupies could not be established\n           evidence: the PEB-reported image base, the image's optional header, the dump's memory region table\n      [??] image size vs. loader record: unavailable -- no loader module record was matched at this image base (see the loader record line above for whether one could be)\n           evidence: the image's optional header, the loader's module list\n      [OK] image size vs. section table: every decoded section fits inside the declared image size\n           evidence: the image's optional header, the image's section table\n      [??] timestamp vs. loader record: unavailable -- no loader module record was matched at this image base to compare against\n           evidence: the image's COFF header, the loader's module list\n      [--] checksum vs. loader record: not applicable -- the header carries no checksum, which is ordinary for a linked image\n           evidence: the image's optional header, the loader's module list\n      [??] architecture vs. a second source: unavailable -- the dump carries no second source for this image's architecture\n           evidence: the image's COFF header\n      [OK] section 0 (.text): the section's address range is representable at this load address\n           evidence: the PEB-reported image base, the image's section table\n      [OK] section 0 (.text): the section fits inside the declared image size\n           evidence: the image's optional header, the image's section table\n      [OK] section 0 (.text): the section shares no address with another section\n           evidence: the image's section table\n      [--] directory 0 (EXPORT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [OK] directory 1 (IMPORT): the directory fits inside the declared image size\n           evidence: the image's optional header, the image's data directory descriptors\n      [--] directory 2 (RESOURCE): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 3 (EXCEPTION): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 4 (SECURITY): not applicable -- this directory is addressed by file offset, not by image RVA, so it is not part of the mapping\n           evidence: the image's data directory descriptors\n      [--] directory 5 (BASERELOC): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 6 (DEBUG): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 7 (ARCHITECTURE): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 8 (GLOBALPTR): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 9 (TLS): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 10 (LOAD_CONFIG): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 11 (BOUND_IMPORT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [OK] directory 12 (IAT): the directory fits inside the declared image size\n           evidence: the image's optional header, the image's data directory descriptors\n      [--] directory 13 (DELAY_IMPORT): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 14 (COM_DESCRIPTOR): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n      [--] directory 15 (RESERVED): not applicable -- the image declares this directory absent\n           evidence: the image's data directory descriptors\n\n    Header Acquisition                           [--verbose only]\n      Requested window         0x1000 bytes at the image base\n      Captured in that window  0x3b0 bytes\n      Required for parsing     0x1b0 bytes\n      Required bytes present   yes\n      Segment table            walked in full\n      Region table             not in this dump\n                               the dump's memory region table is not in this dump: any check or context that needed the table is withheld, not decided\n      Parsing                  completed through the section table, as requested\n      Header components        read in full: DOS header, COFF header, optional header, directory array, directory descriptors, section table\n      Named as                 C:\\Samples\\malware.exe (path from the PEB-reported image base)\n\n  Import Address Table\n    2 import(s) across 2 DLL(s)\n\n    Each row reads IAT Slot VA -> Resolved Target VA.\n    The slot is the address where the import pointer is stored; the target is the\n    address stored in that slot in the captured process memory.\n\n    DLL                       Imported API                  IAT Slot VA           Resolved Target VA\n    ADVAPI32.dll              ordinal #12                   0x00007ff600013000    0x00007ffb0000000c\n    (unknown)                 (unavailable)                 0x00007ff600013010    0x00007ffb00000099\n\n  Identity\n    [!] a module named malware.exe is loaded at 0x00007ff700000000, not the PEB-reported image base 0x00007ff600010000\n\n  Identity Verification                            [--verbose only]\n    Selected path    C:\\Samples\\malware.exe\n    Selected name    malware.exe\n    Source           PEB (ProcessParameters.ImagePathName)\n    Image base       0x00007ff600010000 (source: PEB)\n\n    [!!] no module is registered at the PEB image base\n         a module named malware.exe is registered at 0x00007ff700000000 instead\n    [??] PEB and ModuleList process names could not be compared\n         one of the two names was not recovered\n    [OK] a valid PE header was found at the PEB image base\n    [OK] no competing module shares this process name\n\n    Raw claims       PEB                              ModuleList\n    path             C:\\Samples\\malware.exe           (none)\n    name             malware.exe                      (none)\n    image base       0x00007ff600010000               (none) (unregistered)\n\n  Extended PEB\n    PEB Address        0x0000000000000000\n    BeingDebugged      False\n    WindowTitle        (none)\n    DllPath            (none)\n    StandardInput      (unknown)\n    StandardOutput     (unknown)\n    StandardError      (unknown)\n",
        {'kind': 'process', 'execution_status': 'completed', 'coverage': {'status': 'complete', 'reasons': [], 'sources': {'process_identity': {'state': 'present', 'record_count': 5, 'detail': None}, 'misc_info': {'state': 'present', 'record_count': 1, 'detail': None}, 'peb': {'state': 'present', 'record_count': 1, 'detail': None}, 'modules': {'state': 'present', 'record_count': 1, 'detail': None}, 'main_image': {'state': 'present', 'record_count': 1, 'detail': None}, 'iat': {'state': 'present', 'record_count': 2, 'detail': None}}, 'limitations': []}, 'summary': {'count': 1}, 'data': {'records': [{'process_name': 'malware.exe', 'pid': 4242, 'process_path': 'C:\\Samples\\malware.exe', 'command_line': 'C:\\Samples\\malware.exe', 'process_start_utc': '2026-08-14 01:15:05 UTC', 'image_base_address': '0x00007ff600010000', 'iat': {'table_present': True, 'table_va': '0x00007ff600013000', 'table_size': 32, 'import_directory_present': True, 'import_directory_va': '0x00007ff600012000', 'import_directory_size': 60, 'has_entries': True, 'dll_count': 2, 'entry_count': 2, 'entries': [{'dll': 'ADVAPI32.dll', 'import_by': 'ordinal', 'symbol': None, 'ordinal': 12, 'iat_slot_va': '0x00007ff600013000', 'resolved_target_va': '0x00007ffb0000000c', 'slot_in_bounds': True}, {'dll': None, 'import_by': 'unavailable', 'symbol': None, 'ordinal': None, 'iat_slot_va': '0x00007ff600013010', 'resolved_target_va': '0x00007ffb00000099', 'slot_in_bounds': True}], 'diagnostics': []}, 'identity_evidence': {'misc_info_claim': {'pid': 4242, 'process_create_time_utc': '2026-08-14 01:15:05 UTC', 'raw_pid': None, 'raw_process_create_time': None}, 'peb_claim': {'image_base_address': '0x00007ff600010000', 'image_path': 'C:\\Samples\\malware.exe', 'name': 'malware.exe', 'raw_image_base_address': None, 'raw_image_path': None, 'raw_command_line': None}, 'module_claim': {'match_state': 'unregistered', 'base_address': None, 'name': None, 'path': None, 'name_matched_candidate': {'base_address': '0x00007ff700000000', 'name': 'malware.exe', 'path': 'C:\\Windows\\Temp\\malware.exe'}, 'name_matched_candidate_ambiguous': False}, 'main_image_pe': {'checked': True, 'valid': True, 'reason': None}, 'selected_path_source': 'peb', 'diagnostics': [{'code': 'PROCESS_MODULE_BASE_CONFLICT', 'severity': 'warning', 'message': 'a module named malware.exe is loaded at 0x00007ff700000000, not the PEB-reported image base 0x00007ff600010000', 'affected_count': None, 'details': {'name': 'malware.exe', 'module_base': '0x00007ff700000000', 'peb_base': '0x00007ff600010000'}}]}, 'pe_image': {'collected': True, 'correlated': True, 'unavailable_reason': None, 'source_kind': 'peb_image_base', 'module_identity': {'value': 'C:\\Samples\\malware.exe', 'form': 'path', 'truncated': False}, 'actual_base': '0x00007ff600010000', 'preferred_image_base': '0x00007ff600010000', 'format': 'PE32+', 'machine': 34404, 'machine_name': 'AMD64', 'time_date_stamp': 305419896, 'checksum': 0, 'subsystem': 0, 'dll_characteristics': 0, 'coff_characteristics': 258, 'size_of_image': 28672, 'size_of_headers': 0, 'section_alignment': 0, 'file_alignment': 0, 'declared_section_count': 1, 'decoded_section_count': 1, 'structural_state': 'complete', 'relocation': {'delta': 0, 'relocs_stripped': False, 'dynamic_base': False, 'basereloc_present': False, 'basereloc_descriptor_state': 'declared_absent'}, 'entry_point': {'rva': 4096, 'va': '0x00007ff600011000', 'va_overflow': False, 'section_index': 0, 'section_name': '.text', 'capture_state': 'none', 'region_state': None, 'region_type': None, 'region_protection': None}, 'acquisition': {'requested_stage': 'sections', 'highest_completed_stage': 'sections', 'requested_bytes': 4096, 'captured_bytes': 944, 'read_bytes': 432, 'read_target_bytes': 432, 'target_io_short': False, 'bounded_stop': None, 'components': {'dos_header': 'complete', 'coff_header': 'complete', 'optional_header': 'complete', 'directory_array': 'complete', 'directory_descriptors': 'complete', 'section_table': 'complete'}, 'segment_table': 'enumerated', 'region_table': 'absent', 'capture_overlapping': False, 'unexamined': []}, 'directory_summary': {'declared_count': 16, 'declared_count_raw': 16, 'readable_count': 16, 'unprojected_count': 0}, 'module_match': 'unregistered', 'observation_coverage': {'total': 29, 'consistent': 10, 'conflict': 0, 'unavailable': 4, 'not_applicable': 15}, 'sections': [{'section_index': 0, 'name': '.text', 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_raw_data': 8192, 'characteristics': 1610612736, 'declared_readable': True, 'declared_writable': False, 'declared_executable': True, 'mapped_base_address': '0x00007ff600011000', 'mapped_size': 8192, 'capture_state': 'none', 'live_protections': []}], 'directories': [{'index': 0, 'name': 'EXPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 1, 'name': 'IMPORT', 'value': 8192, 'value_kind': 'rva', 'size': 60, 'bytes_read': 8, 'present': True, 'descriptor_state': 'complete', 'containing_section_index': 0, 'capture_state': 'complete'}, {'index': 2, 'name': 'RESOURCE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 3, 'name': 'EXCEPTION', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 4, 'name': 'SECURITY', 'value': 0, 'value_kind': 'file_offset', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 5, 'name': 'BASERELOC', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 6, 'name': 'DEBUG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 7, 'name': 'ARCHITECTURE', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 8, 'name': 'GLOBALPTR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 9, 'name': 'TLS', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 10, 'name': 'LOAD_CONFIG', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 11, 'name': 'BOUND_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 12, 'name': 'IAT', 'value': 12288, 'value_kind': 'rva', 'size': 32, 'bytes_read': 8, 'present': True, 'descriptor_state': 'complete', 'containing_section_index': None, 'capture_state': 'complete'}, {'index': 13, 'name': 'DELAY_IMPORT', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 14, 'name': 'COM_DESCRIPTOR', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}, {'index': 15, 'name': 'RESERVED', 'value': 0, 'value_kind': 'rva', 'size': 0, 'bytes_read': 8, 'present': False, 'descriptor_state': 'declared_absent', 'containing_section_index': None, 'capture_state': None}], 'observations': [{'name': 'base_vs_preferred', 'state': 'consistent', 'reason': 'delta_recorded', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'actual_base': 140694538747904, 'preferred_image_base': 140694538747904, 'relocation_delta': 0}}, {'name': 'relocation_expected', 'state': 'consistent', 'reason': 'zero_delta', 'sources': ['profile.source:peb_image_base', 'profile.optional_header'], 'operands': {'relocation_delta': 0, 'relocs_stripped': False, 'basereloc_present': False}}, {'name': 'machine_vs_format', 'state': 'consistent', 'reason': 'format_matches_machine', 'sources': ['profile.coff_header', 'profile.optional_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64', 'is_pe32_plus': True}}, {'name': 'entry_point_in_section', 'state': 'consistent', 'reason': 'entry_point_in_decoded_section', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'address_of_entry_point': 4096, 'section_table_state': 'complete', 'containing_section_index': 0}}, {'name': 'size_vs_image_extent', 'state': 'unavailable', 'reason': 'regions_unavailable', 'sources': ['profile.source:peb_image_base', 'profile.optional_header', 'memory_info'], 'operands': {'size_of_image': 28672}}, {'name': 'size_vs_modulelist', 'state': 'unavailable', 'reason': 'no_modulelist_entry', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'size_of_image': 28672, 'modulelist_size': None}}, {'name': 'size_vs_section_extent', 'state': 'consistent', 'reason': 'size_covers_section_extent', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'size_of_image': 28672, 'section_table_state': 'complete', 'section_extent': 12288}}, {'name': 'identity_time_date_stamp', 'state': 'unavailable', 'reason': 'no_second_source', 'sources': ['profile.coff_header', 'module_list'], 'operands': {'header_value': 305419896, 'module_list_value': None}}, {'name': 'identity_check_sum', 'state': 'not_applicable', 'reason': 'header_checksum_absent', 'sources': ['profile.optional_header', 'module_list'], 'operands': {'header_value': 0, 'module_list_value': None}}, {'name': 'identity_machine', 'state': 'unavailable', 'reason': 'machine_no_independent_source', 'sources': ['profile.coff_header'], 'operands': {'machine': 34404, 'machine_name': 'AMD64'}}, {'name': 'section_range_overflow', 'state': 'consistent', 'reason': 'section_range_representable', 'sources': ['profile.source:peb_image_base', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'actual_base': 140694538747904}}, {'name': 'section_image_bound', 'state': 'consistent', 'reason': 'section_within_image_bound', 'sources': ['profile.optional_header', 'profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192, 'size_of_image': 28672}}, {'name': 'section_overlap', 'state': 'consistent', 'reason': 'section_disjoint_from_others', 'sources': ['profile.section_table'], 'operands': {'section_index': 0, 'virtual_address': 4096, 'virtual_size': 8192}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 0, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'consistent', 'reason': 'directory_within_image_bound', 'sources': ['profile.optional_header', 'profile.directory_descriptors'], 'operands': {'index': 1, 'value': 8192, 'size': 60, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 2, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 3, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'file_offset_semantics', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 4, 'value': 0, 'size': 0, 'value_kind': 'file_offset'}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 5, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 6, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 7, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 8, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 9, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 10, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 11, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'consistent', 'reason': 'directory_within_image_bound', 'sources': ['profile.optional_header', 'profile.directory_descriptors'], 'operands': {'index': 12, 'value': 12288, 'size': 32, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 13, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 14, 'value': 0, 'size': 0, 'size_of_image': 28672}}, {'name': 'directory_image_bound', 'state': 'not_applicable', 'reason': 'directory_declared_absent', 'sources': ['profile.directory_descriptors'], 'operands': {'index': 15, 'value': 0, 'size': 0, 'size_of_image': 28672}}]}, 'peb_extended': {'peb_address': '0x0000000000000000', 'being_debugged': False, 'window_title': None, 'dll_path': None, 'standard_input': None, 'standard_output': None, 'standard_error': None}}]}},
    ),
    (
